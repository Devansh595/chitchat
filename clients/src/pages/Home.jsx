...
function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-[#282C35!] scrollbar-hide z-10 h-full  lg:w-[90%] lg:mx-auto overflow-y-hidden shadow-2xl border-2px border-solid border-black">
            ...
            !showProfile ?
              <div className="md:flex md:flex-col min-w-[360px] h-[100vh] md:h-[98.6vh] bg-[#ffff] relative">
                ...
                <div className='h-[61px] px-4'>
                  <div className='flex'>
                    <a className=' items-center relative  top-4 block h-[90px]' href='/'>
