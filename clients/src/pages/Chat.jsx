    ...
    <>
      {
        activeChat ?
          <div className={props.className}>
            ...
            <div className='absolute left-[11%] bottom-[5%]'>
              {
                showPicker && <Picker data={data} onEmojiSelect={(e) => setMessage(message + e.native)} />
              }
              <div className='border-[1px] border-[#aabac8] px-6 py-3 w-[360px] sm:w-[400px] md:w-[350px] h-[50px] lg:w-[700px] rounded-[10px] flex justify-between items-center'>

                <div className='flex justify-between items-center'>
                  <div className='cursor-pointer pr-4' onClick={() => setShowPicker(!showPicker)}>
